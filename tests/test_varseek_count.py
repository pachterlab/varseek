...
sample_size = 12_000  # number of reads
make_new_gt = False
...
vk_ref_folder = os.path.join(reference_folder_parent, "vk_ref_out")
fastq_file = os.path.join(reference_folder_parent, "ccle_data_base", "RNASeq_MELHO_SKIN", "SRR8615233_1_head.fastq")
...
def test_vk_count(out_dir):
    ...
    if not os.path.exists(fastq_file):
        ...
        # !zcat {fastq_file_full} | head -1000000 > $fastq_file
    ...
    files_to_compare_and_file_type = [
        ("kb_count_vcrs_out_dir/count_unfiltered/adata.h5ad", "adata"),
        ("adata_cleaned.h5ad", "adata"),
        ("variants.vcf", "vcf"),
        #!! add some summarize files too
        #!! add QC'd fastq
    ]

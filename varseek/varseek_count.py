...
from .constants import supported_downloadable_normal_reference_genomes_with_kb_ref, non_single_cell_technologies
...
def count(
    ...
    **kwargs  #* including all arguments for vk build, info, and filter
    ...
    - index                                 (str)  Path to mutation index generated by varseek ref

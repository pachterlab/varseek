...
def summarize(adata_path, assay = "bulk", output_dir = ".", overwrite = False, top_values = 10, verbose=False, **kwargs):
    ...
    most_common_mutations = adata.var.sort_values(by=['number_of_samples_in_which_the_mutation_is_detected', 'mcrs_count'], ascending=False)
    ...
    most_common_genes = gene_presence_df.sort_values(by=['number_of_samples_in_which_the_gene_is_detected', 'total_mcrs_count'], ascending=False)
